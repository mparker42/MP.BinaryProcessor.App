...
{
    [TestClass]
    public class DecodeMessageHandlerMessageTypeTests : BaseTests
    {
        ...
        private const int response = 255;

        public override MessageSchemaItem[] GetMessageSchemaItems()
        {
            return new[] { new MessageSchemaItem { DisplayName = _fakeSchemaDisplayName, BinaryDataType = Enums.BinaryDataType.MessageType, Length = 4, StartPosition = 2 } };
        }
        ...
        [TestMethod]
        public void HandlerReadsMessageType()
        {
            ...
            decodeResult.Should().Contain($"{_fakeSchemaDisplayName}: Developer Test Message");
