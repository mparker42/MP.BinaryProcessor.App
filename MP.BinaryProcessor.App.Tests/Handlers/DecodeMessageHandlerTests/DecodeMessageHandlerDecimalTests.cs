...
{
    [TestClass]
    public class DecodeMessageHandlerDecimalTests : BaseTests
    {
        ...
        private const int response = 2_000_000;

        public override MessageSchemaItem[] GetMessageSchemaItems()
        {
            return new[] { new MessageSchemaItem { DisplayName = _fakeSchemaDisplayName, BinaryDataType = Enums.BinaryDataType.DecimalFromInt32, Length = 4, StartPosition = 2 } };
        }
        ...
        [TestMethod]
        public void HandlerReadsDecimal()
        {
            ...
            decodeResult.Should().Contain($"{_fakeSchemaDisplayName}: 3.3333333333333333333333333333");
