...
{
    [TestClass]
    public class DecodeMessageHandlerInt32Tests : BaseTests
    {
        ...
        private const int response = 2332;

        public override MessageSchemaItem[] GetMessageSchemaItems()
        {
            return new[] { new MessageSchemaItem { DisplayName = _fakeSchemaDisplayName, BinaryDataType = Enums.BinaryDataType.LittleEndianInt32, Length = 4, StartPosition = 2 } };
        }
